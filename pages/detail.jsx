                ...
                <Row className="comm_main" justify="center">
                    ...
                    >
                        <Breadcrumb ><Breadcrumb.Item>
                            <a href="/">首页</a></Breadcrumb.Item>
                            <Breadcrumb.Item>
                                文章详情
                            </Breadcrumb.Item></Breadcrumb>
                        <Affix className="navbar" offsetTop={50} offsetBottom={0}>
                            <div className="title">文章导航</div>
                            <MarkdownNavbar className="post_nav"
                    ...
                    >
                        <section className="post">
                            ...
                            <div className="content">
                                <ReactMarkdown allowDangerousHtml={false}>
                                    {postData.content}
                                </ReactMarkdown>
                            </div>
                        </section>
